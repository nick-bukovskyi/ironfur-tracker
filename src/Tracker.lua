...
function Tracker.HandleSpellcast(spellID, now, talents)
  ...
  local hasGuardianOfElune = talents.guardianOfElune and guardianOfEluneExpiresAt > now
  local duration = Tracker.CalculateIronfurDuration(talents.ursocsEndurance, hasGuardianOfElune)
